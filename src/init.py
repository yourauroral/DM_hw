...
# 读入数据
amount = pd.read_csv(r'E:\myStage\the3rd\数据挖掘\课设\SCBAnalysis\src\data\data2.csv', encoding='gb2312')
student = pd.read_csv(r'E:\myStage\the3rd\数据挖掘\课设\SCBAnalysis\src\data\data1.csv', encoding='gb2312')
...
amount.to_csv(os.path.join('data', 'task1_1_1.csv'))

# grade18.csv，只有18级的信息，但是有很多个人信息
data = pd.merge(student, amount, on=['CardNo'])
data.to_csv(os.path.join('data', 'task1_1_2.csv'))
