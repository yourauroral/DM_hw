...
# 制作需要用到的常量
color_map = {
    '第一食堂': '#4B8AEE',  # Sky Blue
    '第二食堂': '#6EBE44',  # Greenery
    '第三食堂': '#EAB84D',  # Golden Yellow
    '第四食堂': '#D04E6D',  # Soft Red
    '第五食堂': '#A76D9A',  # Lavender
    '教师食堂': '#F89D39'   # Warm Orange
}
...
"""数据预处理"""
# 创建食堂的数据
canteen = pd.read_csv(r'E:\myStage\the3rd\数据挖掘\课设\SCBAnalysis\src\data\task1_1_1.csv') # 读取数据
